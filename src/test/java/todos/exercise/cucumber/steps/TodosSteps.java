...
/** This class contains the steps related to the todos feature scenarios */
public class TodosSteps {
  ...
  public void i_see_a_todo_with_an_id(String stringToAssert) throws Throwable {
    service.assertResponseJsonByTodoID(stringToAssert);
  }

  @When("^I post a todo with an id (\\d+) and title \"([^\"]*)\" and body \"([^\"]*)\"$")
  public void i_post_a_new_todo(final int todoID, final String todoTitle, final String todoBody)
      throws Throwable {
  ...
  public void i_update_a_todo(final int todoID, final String todoTitle, final String todoBody)
      throws Throwable {
